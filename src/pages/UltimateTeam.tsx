...
import { Trophy, Users, Shield, Plus, X, RotateCcw, Save, Trash2, Check, Star, Sparkles, AlertCircle, Download, Copy } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-16">
      ...
      <div className="bg-white border border-slate-200 rounded-sm p-4 sm:p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-sm">
        ...
        <div className="flex bg-slate-50 p-1 border border-slate-200 rounded-sm w-full md:w-auto flex-wrap gap-1 md:gap-0">
          <button
            onClick={saveSquad}
            className="flex-1 md:flex-none flex items-center justify-center gap-1.5 px-4 py-2.5 bg-blue-600 hover:bg-blue-750 text-white font-black text-xs uppercase tracking-widest transition-all cursor-pointer rounded-sm"
          ...
          <button
            onClick={exportToPNG}
            className="flex-1 md:flex-none flex items-center justify-center gap-1.5 px-4 py-2.5 bg-green-600 hover:bg-green-700 text-white font-black text-xs uppercase tracking-widest transition-all cursor-pointer rounded-sm"
            title="Baixar imagem da escalação"
          >
          ...
          <button
            ...
            className="flex-1 md:flex-none flex items-center justify-center gap-1.5 px-4 py-2.5 bg-white border border-slate-200 hover:bg-slate-100 text-slate-700 font-semibold text-xs uppercase tracking-widest transition-all cursor-pointer rounded-sm"
          ...
          <button
            ...
            className="flex-1 md:flex-none flex items-center justify-center gap-1.5 px-4 py-2.5 text-slate-500 hover:text-red-650 hover:bg-red-50/60 font-bold text-xs uppercase tracking-wider transition-all cursor-pointer rounded-xs"
            ...
            <div className="flex justify-between items-center pt-2">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-5 py-2.5 bg-blue-600 hover:bg-blue-750 text-white rounded-sm text-xs font-mono font-black uppercase tracking-wider transition-all cursor-pointer flex items-center gap-1.5"
                >
                  <Copy className="h-3.5 w-3.5" />
                  Copiar Novamente
                </button>
                <button
                  onClick={() => setExportedText(null)}
                  className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-650 rounded-sm text-xs font-mono font-black uppercase tracking-wider transition-all cursor-pointer"
                >
                  Fechar
                </button>
              </div>
